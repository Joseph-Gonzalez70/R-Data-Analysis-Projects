...
cat('[',
    z_0%*%beta_hat - sqrt(sigma_hat_square)*sqrt(solve(t(z_0)%*%solve(t(Z)%*%Z)%*%z_0))*qt(1-alpha/2, n-r-1),
    ',',
    z_0%*%beta_hat + sqrt(sigma_hat_square)*sqrt(solve(t(z_0)%*%solve(t(Z)%*%Z)%*%z_0))*qt(1-alpha/2, n-r-1),
    ']')
...
cat('[',
    z_0%*%beta_hat - sqrt(sigma_hat_square)*sqrt(1+solve(t(z_0)%*%solve(t(Z)%*%Z)%*%z_0))*qt(1-alpha/2, n-r-1),
    ',',
    z_0%*%beta_hat + sqrt(sigma_hat_square)*sqrt(1+solve(t(z_0)%*%solve(t(Z)%*%Z)%*%z_0))*qt(1-alpha/2, n-r-1),
    ']')
